...
public class ItemChocolateApple extends ItemFood
{
    ...
    public ItemChocolateApple(int p_i45341_1_, float p_i45341_2_, boolean p_i45341_3_)
    {
    ...
    protected void onFoodEaten(ItemStack p_77849_1_, World p_77849_2_, EntityPlayer p_77849_3_)
    {
        ...
        {
            p_77849_3_.addPotionEffect(new PotionEffect(Potion.field_76444_x.id, 2400, 4));
        ...
        if (p_77849_1_.getItemDamage() > 0)
        {
            if (!p_77849_2_.isRemote)
            {
                p_77849_3_.addPotionEffect(new PotionEffect(Potion.nightVision.id, 600, 1));
            }
        }
        else
        {
